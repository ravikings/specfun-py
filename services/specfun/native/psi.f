...
C----------------------------------------------------------------------
C     DATA ZERO,FOURTH,HALF,ONE/0.0E0,0.25E0,0.5E0,1.0E0/
C     DATA THREE,FOUR/3.0E0,4.0E0/,PIOV4/7.8539816339744830962E-01/
      DATA ZERO,FOURTH,HALF,ONE/0.0D0,0.25D0,0.5D0,1.0D0/
      DATA THREE,FOUR/3.0D0,4.0D0/,PIOV4/7.8539816339744830962D-01/
C----------------------------------------------------------------------
C  Machine-dependent constants
C----------------------------------------------------------------------
C     DATA XINF/1.70E+38/, XMIN1/5.89E-39/, XMAX1/8.38E+06/,
C    1     XSMALL/1.35E-04/, XLARGE/1.20E+06/
      DATA XINF/1.70D+38/, XMIN1/5.89D-39/, XMAX1/3.60D+16/,
     1     XSMALL/2.05D-09/, XLARGE/2.04D+15/
C----------------------------------------------------------------------
C  Zero of psi(x)
C----------------------------------------------------------------------
C     DATA X01/187.0E0/,X01D/128.0E0/,X02/6.9464496836234126266E-04/
      DATA X01/187.0D0/,X01D/128.0D0/,X02/6.9464496836234126266D-04/
C----------------------------------------------------------------------
C  Coefficients for approximation to  psi(x)/(x-x0)  over [0.5, 3.0]
C----------------------------------------------------------------------
C     DATA P1/4.5104681245762934160E-03,5.4932855833000385356E+00,
C    1        3.7646693175929276856E+02,7.9525490849151998065E+03,
C    2        7.1451595818951933210E+04,3.0655976301987365674E+05,
C    3        6.3606997788964458797E+05,5.8041312783537569993E+05,
C    4        1.6585695029761022321E+05/
C     DATA Q1/9.6141654774222358525E+01,2.6287715790581193330E+03,
C    1        2.9862497022250277920E+04,1.6206566091533671639E+05,
C    2        4.3487880712768329037E+05,5.4256384537269993733E+05,
C    3        2.4242185002017985252E+05,6.4155223783576225996E-08/
...
C     for  x > 3.0
C----------------------------------------------------------------------
C     DATA P2/-2.7103228277757834192E+00,-1.5166271776896121383E+01,
C    1        -1.9784554148719218667E+01,-8.8100958828312219821E+00,
C    2        -1.4479614616899842986E+00,-7.3689600332394549911E-02,
C    3        -6.5135387732718171306E-21/
C     DATA Q2/ 4.4992760373789365846E+01, 2.0240955312679931159E+02,
C    1         2.4736979003315290057E+02, 1.0742543875702278326E+02,
C    2         1.7463965060678569906E+01, 8.8427520398873480342E-01/
